...
<div class="container-fluid">
  <h2 class="text-center mb-5">Library Clearance</h2>
  <hr>
  <div class="row mt-3">
    <div class="col-md-6">
      <h3 class="text-center mt-4 mb-4">Your Current Status</h3>
      <p class="pl-4 pr-4">Dear Vincent Michael, you are uncleared at the library.
  ...
  <div style="margin-top:200px;">
    <p class="mt-5 text-center text-danger">
      Please Proceed to the Library if you have issues
    with Library</p>
  </div>
</div>
@endsection
