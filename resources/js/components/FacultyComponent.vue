<template>
  <div class="container">
    <h3 class="text-center">Faculty Department</h3>
    <table class="table">
      <thead>
        <tr>
      ...
      <tbody>
        <tr v-for="student,key in students">
          ...
          <td v-if="student.facultycleared==1">cleared</td>
          <td v-else>Uncleared</td>
          <td><a type="button" id="show-modal" @click="showModal=true;
            setVal(student.id, student.reg_no, student.name, student.facultycleared)"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLongTitle"><a href="#">Edit Student Record</a></h5>
    ...
    let vm = this;
     ...
     makePagination(meta, links){
      ...
      updateStudent(){
        ...
        var facultycleared = document.getElementById('status').value
        axios.put(`api/updatefacultystatus/${id}`,
          {
            reg_no:reg_no,
            name:name,
            facultycleared:facultycleared
          })
          .then(
            res =>{
              this.getStudents()
